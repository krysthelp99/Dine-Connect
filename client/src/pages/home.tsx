...
const popularMenu = [
  {
    ...
    description:
      "Crispy fried chicken smashed with our authentic hand-ground sambal cobek.",
    price: "RM 15.90",
    category: "The Heat",
    color: "bg-primary",
  },
  {
    ...
    description:
      "Thick-cut artisanal toast slathered in premium pistachio cream and crushed nuts.",
    price: "RM 12.90",
    category: "The Sweet",
    color: "bg-secondary",
  },
  {
    ...
    description:
      "A unique blend of traditional spices with a modern twist, served with sunny side up.",
    price: "RM 14.90",
    category: "The Heat",
    color: "bg-primary",
  },
    ...
    <div className="min-h-screen bg-background selection:bg-primary/20">
      ...
      <nav className="fixed w-full z-50 px-6 py-8 flex justify-between items-center transition-all bg-background/80 backdrop-blur-md">
        ...
        <div className="hidden md:flex items-center gap-12 text-[11px] uppercase tracking-[0.3em] font-bold">
          ...
          <button className="bg-primary text-white px-8 py-3 hover:translate-y-[-2px] active:translate-y-[0px] transition-all shadow-lg shadow-primary/20">
            Visit
          </button>
        </div>
      ...
      <section className="relative h-screen flex flex-col justify-center px-6 md:px-24">
        ...
        <motion.div
          ...
          variants={slideUp}
        >
          <span className="text-[12px] uppercase tracking-[0.5em] mb-8 block text-secondary font-black">
            Miri — Sarawak
          </span>
          ...
          <p className="text-xl md:text-2xl font-light text-white/80 mb-12 tracking-[0.1em] uppercase max-w-2xl">
            Indo-Fusion{" "}
            <span className="italic font-serif normal-case tracking-normal text-secondary font-bold underline decoration-primary underline-offset-8">
              reimagined.
            </span>
          </p>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div>
              <span className="text-[10px] uppercase tracking-[0.5em] text-primary font-black mb-8 block">
                Our Story
              </span>
              <h2 className="text-5xl md:text-6xl font-heading mb-10 leading-[1.1] font-bold">
                A Sanctuary <br />
                <span className="text-accent italic">of Flavors.</span>
              </h2>
              <p className="font-light text-xl text-foreground/80 leading-relaxed mb-8 border-l-4 border-primary pl-8">
                Born in the heart of Miri, Mami Kopitiam is where the soul of
                Indonesian street food meets the refined simplicity of a modern
                sanctuary.
              </p>
              <p className="font-light text-foreground/60 leading-relaxed max-w-md">
                We believe that heat and sweetness aren't just flavors—they're
                experiences. Every dish is crafted with a respect for heritage
                and a passion for contemporary vibes.
              </p>
            </div>
      ...
      <section
        id="menu"
        className="py-32 px-6 md:px-24 bg-foreground text-background"
      >
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
            <div className="max-w-xl">
              <span className="text-[10px] uppercase tracking-[0.5em] text-secondary font-black mb-6 block">
                Selection
              </span>
              <h2 className="text-5xl md:text-7xl font-heading font-bold leading-none">
                THE SIGNATURES.
              </h2>
            </div>
            <p className="font-light text-background/60 text-lg uppercase tracking-widest">
              A curated list of our most loved signatures.
            </p>
          </div>
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center gap-4 mb-4">
                    <span
                      className={`text-[10px] uppercase tracking-widest px-4 py-1 ${item.color} text-white font-black`}
                    >
                      {item.category}
                    </span>
                    <h3 className="text-3xl font-heading font-bold uppercase tracking-tighter">
                      {item.name}
                    </h3>
                  </div>
                  <p className="font-light text-background/40 text-lg max-w-xl group-hover:text-background/80 transition-colors">
                    {item.description}
                  </p>
                </div>
      ...
      <section className="py-32 px-6 md:px-24">
        <div className="grid md:grid-cols-2 gap-32 items-center max-w-7xl mx-auto">
          <motion.div
            ...
            variants={fadeIn}
          >
            <h2 className="text-6xl font-heading font-bold mb-16 tracking-tighter uppercase leading-none">
              SPICY
              <br />
            ...
            <div className="space-y-16">
              <div className="relative pl-12">
                ...
                <h3 className="text-lg uppercase tracking-[0.3em] font-black mb-4">
                  The Heat
                </h3>
                <p className="font-light text-foreground/60 leading-relaxed text-lg">
                  Our Signature Sambal Cobek is hand-ground daily. It provides a
                  slow, meaningful heat that complements our Ayam Gepuk.
                </p>
              </div>
              <div className="relative pl-12">
                ...
                <p className="font-light text-foreground/60 leading-relaxed text-lg">
                  Viral Pistachio Butter Toast. A modern take on the classic
                  Kopitiam breakfast, designed for the contemporary palate.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-24 items-center max-w-7xl mx-auto">
            <div className="flex flex-col items-start text-left">
              ...
              <h2 className="text-6xl md:text-8xl font-heading font-bold mb-12 tracking-tighter leading-none">
                FIND <br />
                US.
              </h2>
              <div className="space-y-12 mb-16">
                <div>
                  <h4 className="text-[12px] uppercase tracking-[0.5em] font-black text-secondary mb-4">
                    Location
                  </h4>
                  <p className="font-light text-2xl uppercase tracking-wider">
                    Marina Parkcity Phase 2, Miri,
                    <br />
                    Sarawak, Malaysia.
                  </p>
                </div>
              ...
              <Button
                variant="outline"
                className="rounded-none border-white text-white hover:bg-white hover:text-primary px-16 py-8 uppercase text-[12px] tracking-[0.4em] font-black transition-all"
              >
                Map Directions
              </Button>
            </div>
            ...
            <div className="h-[600px] w-full bg-white p-2 rounded-none shadow-[60px_60px_0px_0px_rgba(0,0,0,0.1)]">
              <iframe
                ...
                style={{
                  border: 0,
                  filter: "grayscale(1) contrast(1.2) invert(0)",
                }}
                allowFullScreen
                loading="lazy"
                title="Google Map"
